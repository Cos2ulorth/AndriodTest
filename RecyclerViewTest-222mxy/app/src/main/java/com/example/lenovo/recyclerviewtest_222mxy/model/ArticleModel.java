package com.example.lenovo.recyclerviewtest_222mxy.model;

import com.example.dell.recyclerviewtest_224lx.bean.ArticleBean;
import com.example.dell.recyclerviewtest_224lx.iface.ArticleListener;
import com.example.dell.recyclerviewtest_224lx.iface.Articleiface;
    ...
    public void getResultList(String mod, int page, String sessionID, final ArticleListener listener) {
        ...
        call.enqueue(new Callback<List<ArticleBean>>() {
            ...
            public void onResponse(Call<List<ArticleBean>> call, Response<List<ArticleBean>> response) {
                if (response.isSuccessful() && response.bady()!=null)
